<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TeacherPortal.aspx.cs" Inherits="StSchoolWebsite3rdYearProject.TeacherPortal" %>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a id="registrationNav" class="nav-link" href="#">Grading</a>
                    </li>
                    <li class="nav-item">
                        <a id="reportsNav" class="nav-link" href="#">Reports</a>
                    </li>
                    <li class="nav-item">
                        <a id="subjectsNav" class="nav-link" href="#">My Class</a>
                    </li>
                </ul>
            </div>
            <div class="ml-auto">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <asp:Button runat="server" ID="logoutButton" CssClass="btn btn-primary" href="Loginn.aspx" Text="Logout" />
                    </li>
                </ul>
            </div>
        </nav>
